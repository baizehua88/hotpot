						...
						<div class="widget am-cf">
							...
							<div class="widget-body am-fr">
								...
								<form class="am-form tpl-form-line-form"
									action="<%=basePath%>customer/addMember.do" method="post" enctype="multipart/form-data">
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" id="user-name"
												name="cname" placeholder="请输入会员姓名">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="radio" value="男" name="csex">男
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" id="user-name"
												name="cphone" placeholder="请输入电话号码">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" id="user-name"
												name="cintegral" placeholder="请输入积分额度">
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" id="user-name"
												name="cbirthday" placeholder="请输入生日日期">
										</div>
									</div>
